...
{
    private static bool DebugEnabled => ConnectQueuePlugin.Singleton?.Config.Debug ?? false;

    private static string PluginName => ConnectQueuePlugin.Singleton?.Name ?? "ConnectQueue";
